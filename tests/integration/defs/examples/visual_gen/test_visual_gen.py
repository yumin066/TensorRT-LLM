...
QWEN_IMAGE_LAYERED_FP8_LPIPS_THRESHOLD = 0.05
...
def _generate_qwen_image_layered_lpips_image(
    ...
    _disable_inductor_compile_worker_quiesce()
    if visual_gen_args_path is None:
        args = VisualGenArgs(
            model=model_path,
            torch_compile_config=TorchCompileConfig(enable=False),
        )
...
def test_qwen_image_layered_fp8_sage_lpips_against_golden(tmp_path):
    input_path = tmp_path / "qwen_image_layered_fp8_input.png"
    generated_path = tmp_path / "qwen_image_layered_fp8_generated.png"
    golden_path = tmp_path / "qwen_image_layered_fp8_golden_grid.png"
    generated_lpips_path = tmp_path / "qwen_image_layered_fp8_generated_lpips.png"
    golden_lpips_path = tmp_path / "qwen_image_layered_fp8_golden_grid_lpips.png"
    _copy_qwen_image_layered_lpips_input(tmp_path, input_path)
    _write_qwen_image_layered_lpips_golden_grid(tmp_path, golden_path)
    _generate_qwen_image_layered_lpips_image(
        _lpips_model_path(QWEN_IMAGE_LAYERED_MODEL_SUBPATH),
    ...
    _assert_lpips_below_threshold(score, QWEN_IMAGE_LAYERED_FP8_LPIPS_THRESHOLD)
