...
"""Explicit RGB to limited-range BT.709 YUV420p conversion for video writeout."""
...
def rgb_to_yuv420p_bt709_limited(frames_uint8: torch.Tensor) -> torch.Tensor:
    ...
    # The encoder contract uses truncation rather than rounding.
