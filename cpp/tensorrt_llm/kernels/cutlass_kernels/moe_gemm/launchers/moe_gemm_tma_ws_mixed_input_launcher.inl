    ...
    TmaWarpSpecializedGroupedGemmInput hopper_inputs, int sm_count_, size_t* workspace_size)
{
    ...
    using LayoutC = std::conditional_t<IsFinalizeFusion, TmaWarpSpecializedGroupedGemmInput::LayoutC, cutlass::layout::RowMajor>;         // Layout type for C and D matrix operands
    ...
    using LayoutD = std::conditional_t<IsFinalizeFusion, TmaWarpSpecializedGroupedGemmInput::LayoutD, LayoutC>;
    ...
    using EpilogueFusionOp = cutlass::epilogue::fusion::ScaledAccPerRowBiasPerColScaleScatter<typename cutlass::layout::LayoutTranspose<LayoutD>::type, ElementFinalOutput,
    ...
    {
        // TODO: add simple alpha beta case
        ...
        if constexpr (IsFinalizeFusion)
        {
            ...
            return EpilogueScalars{
                    ElementAccumulator(1), nullptr, hopper_inputs.alpha_scale_ptr_array,
