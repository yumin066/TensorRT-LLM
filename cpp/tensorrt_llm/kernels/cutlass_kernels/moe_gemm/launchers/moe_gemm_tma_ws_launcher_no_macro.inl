...
//#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm90, __nv_fp8_e4m3, cutlass::uint4b_t, __nv_bfloat16, void,
//    EpilogueOpDefault, FINALIZE, 128, 16, 128, 1, 1, 1, false, false, false, true)
//    static void tma_warp_specialized_generic_moe_gemm_kernelLauncher_##Sm90##_##__nv_fp8_e4m3##_##cutlass::uint4b_t##_##__nv_bfloat16##_##void##_##EpilogueOpDefault##_##FINALIZE##_##128##_##16##_##128##_##1##_##1##_##1##_##false##_##false##_##false##_##true(
    static void tma_warp_specialized_generic_moe_gemm_kernelLauncher_(
        ...
        cute::Shape<int32_t, int32_t, cute::_1> fallback_cluster_shape)
    {
        ...
        constexpr static EpilogueFusion FUSION = EpilogueFusion::FINALIZE;
        constexpr static bool IsMXFPX = false;
        constexpr static bool DYNAMIC_CGA = false;
        constexpr static bool SwapAB = true;
        ...
        /* constexpr static bool BIAS = false; */ /* Always false */
        using T = __nv_fp8_e4m3;
        using WeightType = cutlass::uint4b_t;
        using OutputType = __nv_bfloat16;
        using EpilogueTag = tensorrt_llm::cutlass_extensions::EpilogueOpDefault;
        ...
        using MmaTileShape
            = cute::Shape<cute::Int<128*(Is2SM ? 2 : 1)>, cute::Int<16>, cute::Int<128*(IsSM103 ? 3 : 1)>>;
        using InputEpilogueSchedule = void;
                               ...
                               ClusterShape, DYNAMIC_CGA, T>)
        {
            ...
            constexpr static bool IsWIINT4AFP8 = cutlass::platform::is_same<WeightType, cutlass::uint4b_t>::value
                && cutlass::platform::is_same<T, SafeFP8>::value;
            ...
            static_assert(cutlass::platform::is_same<T, WeightType>::value || IsWFP4AFP8 || IsWIINT4AFP8,
            ...
            using KernelScheduleSM90
                = std::conditional_t<IsFP8 && !IsWIINT4AFP8, cutlass::gemm::KernelPtrArrayTmaWarpSpecializedCooperativeFP8FastAccum,
    ...
    template <>
    struct DispatchToTmaWSFunction<cutlass::arch::Sm90, __nv_fp8_e4m3, cutlass::uint4b_t, __nv_bfloat16, void,
        tensorrt_llm::cutlass_extensions::EpilogueOpDefault, EpilogueFusion::FINALIZE,
        cute::Shape<cute::Int<128>, cute::Int<16>, cute::Int<128>>,
        cute::Shape<cute::Int<1>, cute::Int<1>, cute::Int<1>>, false, false, false, true>
    {
        constexpr static auto* op = &tma_warp_specialized_generic_moe_gemm_kernelLauncher_;
    };
